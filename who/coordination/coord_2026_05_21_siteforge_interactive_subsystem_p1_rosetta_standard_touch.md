...
| **P5.3** | Workspace `~/lattice/CLAUDE.md` Standing Rule addition | T1 standing-rule slot (≤ 200 chars per Campaign SO #2) | Slot identification deferred to P5.3 per D8; touch budget pre-committed. |
