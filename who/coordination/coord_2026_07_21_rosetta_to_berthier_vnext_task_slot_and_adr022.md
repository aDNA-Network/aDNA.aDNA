...
status: delivered   # DELIVERED at Refit G3 (2026-07-24) — pushed to origin/aDNA.aDNA; target ingests via cross-vault read of aDNA.aDNA/who/coordination/. Staged-note: FINALIZED 2026-07-21 — G1 SIGNED same-day (ratification_record_refit_g1 rows 1-2, commit 42571db); wording below is the ratified text. Committed for delivery well ahead of the 07-25 tracker re-check / 07-31 due date.
