...
> **Pointer (back-fills before this memo releases at G5):** `how/campaigns/campaign_champollion/artifacts/<M5.2 mutual-conformance findings artifact>` — link inserted here by the orchestrator once M5.2 lands.
