...
**ALREADY-DISCHARGED.** Evidence: ADR-035 accepted; identity (WHO) materialized to the public template at Hearthstone P5 (standard v2.3/2.4). Status set to `resolved`; ratified at Champollion G0 (D2).
