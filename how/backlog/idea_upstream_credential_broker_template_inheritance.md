...
3. **Discipline** — NEVER write a credential value into this vault's files (SO D4=A NAMES ONLY). Vault references use the URI or env-var name only. Apply `~/lattice/doctrine_credential_handling.md` §6 in full (URI-not-value · `head -c N` ≤ 6 · Keychain-export preference · backup-exclusion).
...
- Workspace doctrine: `/Users/stanley/lattice/doctrine_credential_handling.md`
```
