...
| 9 | `LPWhitepaper.aDNA` | — | Whitepaper-vault | v6.0 | Y | `origin-whitepaper` → `/Users/stanley/aDNA/whitepaper` (local path) | LatticeProtocol | **Grandfathered path-style** (ADR-009 §3.4 — path-style remote acceptable for one-vault tooling) | Active (LaTeX + III review) | 2026-05-09 |
