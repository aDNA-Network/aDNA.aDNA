...
| **M03: Repo structure simplification** | P1 | Flatten `.adna`, update `skill_project_fork` + `skill_workspace_upgrade`, migration runbook | **next** (P1 active row; opens at operator discretion post-M08a close; ADR-008 airlock template stub drafted + ratified at M03 phase gate; consumes M08a finalized upgrade guide + LP-internal coord memos) |
