...
> The Contributor Covenant v2.1, adopted as this project's Code of Conduct per
> [`CONTRIBUTING.md`](CONTRIBUTING.md) and [`.adna/who/governance/VISION.md`](.adna/who/governance/VISION.md).
> It applies to every space this project runs — the repositories, the issue trackers, the proposal process, and
...
who are responsible for enforcement, by opening a report through the project's GitHub repository
([github.com/aDNA-Network/aDNA](https://github.com/aDNA-Network/aDNA)) — a
[Discussion](https://github.com/aDNA-Network/aDNA/discussions) for non-sensitive matters, or a direct message to
a repository maintainer for anything confidential. All complaints will be reviewed and investigated promptly and
fairly.

All community leaders are obligated to respect the privacy and security of the reporter of any incident.

> **Maintainer note:** a dedicated confidential reporting address is a tracked follow-up
> (see the M6 dev-readiness audit); until it is published, reports route to the maintainers via the channels above.
