...
mission_count: 33       # ⛩ AMENDED 32 → 33 ON 2026-09-07 AT `GR-6`'S ⛩ SIGNATURE — surfaced, ruled AND PERFORMED in the same commit (the discipline GR-2 had to learn twice). **Derived from disk, not typed** (KW-14): `ls missions/mission_haussmann_*.md | wc -l` → **33** = **27** matching `p[0-5]_*` + **6** matching `gr_*` (GR-1 trust-path, GR-2 CI-freshness, GR-3 false-red, GR-4 story-coverage, GR-5 F-ab/flaky-gates, **GR-6 instrument-calibration**). **GR-6 is a genuinely NEW mission, not a split increment**, on the GR-1…GR-5 precedent. ⚠ `phase_count` HOLDS at 6 — GR is a lane, not a seventh phase. ⚠⚠ **AND THE CAMPAIGN `CLAUDE.md` INDEX WAS STALE AT 31 WHEN GR-6 WAS AUTHORED, WHICH PROPAGATED INTO THE APPROVED SESSION PLAN** — `F-u`'s class, 8th sighting, corrected at the 09-05 sitting. ~~32~~ · prior note follows: ⛩ AMENDED 31 → 32 ON 2026-09-04 AT `GR-5`'S ⛩ PRE-BUILD GATE — surfaced, ruled AND PERFORMED in the same sitting. **Derived from disk, not typed** (KW-14): `ls missions/mission_haussmann_*.md | wc -l` → **32** = **27** matching `p[0-5]_*` + **5** matching `gr_*` (GR-1 trust-path, GR-2 CI-freshness, GR-3 false-red, GR-4 story-coverage/Lane D, **GR-5 F-ab/flaky-gates**). **GR-5 is a genuinely NEW mission, not a split increment**, on the GR-1…GR-4 precedent. ⚠ `phase_count` HOLDS at 6 — GR is a lane, not a seventh phase. ⚠⚠ **AND THE GATE AGENDA WAS INCOMPLETE**: GR-1 and GR-4 each surfaced this amendment as an explicit ⛩ question at their own gates; **GR-5's file did not**, so it was found by *deriving the count* at the recording step rather than by reading the mission's agenda. The mission that exists to measure flaky instruments nearly shipped with a stale count of itself. ~~31~~ · prior note follows: ⛩ AMENDED 30 → 31 ON 2026-09-02 AT `GR-4`'S ⛩ PRE-BUILD GATE — surfaced, ruled AND PERFORMED in the same sitting (GR-3's discipline, which GR-2 had to learn twice). **Derived from disk, not typed** (KW-14): `ls missions/mission_haussmann_*.md | wc -l` → **31** = 27 matching `p{0..5}` + **4** matching `gr_*` (GR-1 trust-path, GR-2 CI-freshness, GR-3 false-red, **GR-4 story-coverage/Lane D**). **GR-4 is a genuinely NEW mission, not a split increment**, on the GR-1/GR-2/GR-3 precedent. ⚠ `phase_count` HOLDS at 6 — GR is a lane, not a seventh phase. ~~30~~ · prior note follows: ⛩ AMENDED 29 → 30 ON 2026-09-01 AT `GR-3`'S CLOSE, IN THE SAME SITTING THE NEED AROSE — the discipline GR-2 had to learn twice (its 28→29 ruling sat unperformed at this destination for four days). **Derived from disk, not typed** (KW-14): `ls missions/mission_haussmann_*.md | wc -l` → **30** = 27 matching `p{0..5}` + **3** matching `gr_*` (GR-1 trust-path, GR-2 CI-freshness, GR-3 false-red). **GR-3 is a genuinely NEW mission, not a split increment**, on the GR-1/GR-2 precedent. ⚠ `phase_count` HOLDS at 6 — GR is a lane, not a seventh phase. ~~29~~ · prior note follows: ⛩ AMENDED 28 → 29 ON 2026-09-01, PERFORMING A RULING TAKEN AT GR-2'S 2026-08-29 SIGNATURE AND NEVER CARRIED OUT HERE. ⚠ The campaign CLAUDE.md recorded the amendment as ruled; this field still read 28 four days later `[D]` — the *index-vs-artifact* class, and the FOURTH sighting in GR-2's close alone. **Derived from disk, not typed** (KW-14): `ls missions/mission_haussmann_*.md | wc -l` → **29** = 27 matching `p{0..5}` + **2** matching `gr_*` (GR-1 trust-path, GR-2 CI-freshness), which the `p{0..5}` glob does not match. **GR-2 is a genuinely NEW mission, not a split increment**, on GR-1's own precedent. ⚠ `phase_count` HOLDS at 6 — GR is a lane, not a seventh phase. ~~28~~ · prior note follows: ⛩ AMENDED 27 → 28 ON 2026-08-28 at GR-1's pre-build gate — the first change to this field since DP6, and it is the operator's to take by this comment's own terms. **GR-1 is a genuinely NEW mission, not a split increment**, so the reasoning below (which held the count at 27 through the P4.5a/b and P4.4a/b splits) does not reach it. Derived: 5+4+6+5+5+2 = 27 across P0–P5, **plus 1 in the GR lane** (see `### GR — Grande Revue`). ⚠ `phase_count` HOLDS at 6 — GR is a lane inside the campaign, not a seventh phase. ~~27~~ · original note follows: 5+4+6+5+5+2; P0–P2 = Decade 1 (committed), P3–P5 = Decade 2 — RECALIBRATED + RATIFIED at ⛩ DP6 2026-08-19. Count HOLDS at 27: ⊳ D-A took option (ii), so P4.5 splits into two increments (P4.5a copy-rows first, P4.5b voice-rewrite last) and a split increment is not a new mission. Option (i) would have amended this field and was therefore explicitly the operator's to take; they declined it.
estimated_sessions: "47-63"   # ⛩ RE-DERIVED 2026-09-07 at `GR-6`'s signature, in the same commit as `mission_count` (both derived-not-typed, so the lane that moves one moves the other): 45–61 + **GR-6's ratified 2** = **47–63**. ~~45-61~~ · prior note follows: ⛩ RE-DERIVED 2026-09-04 at `GR-5`'s signature, in the same commit as `mission_count` (both derived-not-typed, so the lane that moves one moves the other): 44–59 + **GR-5's ratified 1–2** = **45–61**. ~~44-59~~ · prior note follows: ⛩ RE-DERIVED 2026-09-02 at `GR-4`'s signature, in the same commit as `mission_count` (both derived-not-typed, so the lane that moves one moves the other): 42–56 + **GR-4's ratified 2–3** = **44–59**. ~~42-56~~ · prior note follows: ⛩ RE-DERIVED 2026-09-01 at `GR-3`'s close, in the same commit as `mission_count` (both derived-not-typed, so the lane that moves one moves the other): 37–50 + GR-1's 2 + GR-2's 2 + **GR-3's ratified 1–2** = **42–56**. ~~41-54~~ · prior note follows: ⛩ RE-DERIVED 2026-09-01 in the same commit as `mission_count` (both are derived-not-typed, so the lane that moves one moves the other): (7–9 + 6–8 + 8–11 + 7–9 + 6–9 + 3–4) = 37–50, **+ GR-1's ratified 2 + GR-2's ratified 2** = **41–54**. ~~39-52~~ · prior note follows: ⛩ RE-DERIVED 2026-08-28 with the GR lane: (7–9 + 6–8 + 8–11 + 7–9 + 6–9 + 3–4) + **GR 2** = 39–52. ~~37-50~~ — never a typed count (KW-14), so the lane that moved `mission_count` moves this too, in the same commit
calibrated_sessions: "46-53"   # ⛩ RE-DERIVED 2026-09-07 at `GR-6`'s signature: 44–51 + **GR-6's ratified 2** = **46–53**. ~~44-51~~ · prior note follows: ⛩ RE-DERIVED 2026-09-02 at `GR-4`'s signature: 42–48 + **GR-4's ratified 2–3** = **44–51**. ~~42-48~~ · prior note follows: ⛩ RE-DERIVED 2026-09-01 at `GR-3`'s close: DP6's 37–42 + GR-1's 2 + GR-2's 2 + **GR-3's ratified 1–2** = **42–48**. ~~41-46~~ · prior note follows: ⛩ RE-DERIVED 2026-09-01: DP6's 37–42 **+ GR-1's ratified 2 + GR-2's ratified 2** = **41–46**. ⭐ GR-2 is stamped at its RATIFIED 2 and that is also what it ACTUALLY took (session 1 = O0–O3, session 2 = O4–O5), so this addend is measured rather than assumed — the token band ran at/over its top edge while the SESSION count landed exactly. ~~39-44~~ · prior note follows: ⛩ RE-DERIVED 2026-08-28: DP6's 37–42 **+ GR-1's ratified 2** = 39–44. ~~37-42~~. The DP6 derivation below is unchanged and still governs its own terms. ⛩ DP6 ⊳ D-H, 2026-08-19. Derived, not typed: 16 Decade-1 actual (`ls how/sessions/history/2026-08/ | grep -c haussmann` → 17, minus the one that IS P2.6 s1) + 3 for P2.6 (s1 re-score · s2 ratification · s3 the O0b TTFS run + D3 + AAR) + 18–23 for Decade 2 (summed from p2_replan §4). Sits INSIDE estimated_sessions 37–50, at its low end. ⚠ The operator's quoted value was "36-41", derived before the ⊳ D-A split ruling in round 3 added a session; the ruling selected the PRINCIPLE "stamp the number that survives being counted today", which points here. Reverting to 36-41 is a one-line edit — see the D-H stamp in p2_replan.md.
...
### GR — Grande Revue (⛩ **RATIFIED 2026-08-28**; ~~1 mission, ~2 sessions~~ → **5 missions, ~8–11 sessions**) — the late-stage review-and-improve lane
...
> ~~**Lane D is content scope**, gate-decided, and has no mission file yet.~~ ⛩ **CORRECTED 2026-09-04 (SO-6, strike-not-delete): Lane D IS `GR-4`**, which has had a mission file since 2026-09-02 and **closed 2026-09-03**. This sentence stood for two days after the thing it denied existed, and this section also tabled **GR-1 alone** while GR-2, GR-3 and GR-4 were authored, executed and closed. ⇒ *the campaign's own **index-vs-artifact** class, at the charter itself* — the row that routes was three missions staler than the missions it routes to.
...
| **GR-2** | **The `gate-33` CI sitting** — name the cause, do not re-run until it is green | 2 | opus | GR-1 |
| **GR-3** | **The false red** — `gate-42` fails the site for requests `gate-42` itself cancelled | 1–2 | opus | GR-2 |
| **GR-4** | **Story coverage (Lane D)** — the four unhomed stories, and the two the revue was wrong about | 2–3 | opus | GR-3 |
| **GR-5** | **`F-ab` — three gates that are bets on how busy the machine is, and a ratchet whose tooth moves** ⛩ signed 2026-09-04 | 1–2 | opus | **none** |
...
| DP7 | P3.4 | ADR-054 community-link GO/NO-GO on verified prerequisites | ⛩ **FOLDED INTO DP9 — operator, 2026-09-04.** ~~The DP itself is **still owed** on the verified prerequisites at P3.4~~ — it is owed, and it is **not convened separately**: it is answered inside DP9's launch GO on the same evidence, which by then is P5.2's re-scored and field-verified state rather than a second reading of P3.4's. ⚠ **This row and P3.4's mission file disagreed, and the disagreement is the finding.** The mission `status:` reads *"⛩ **DP7 RULED GO**"* and CLOSED the mission on it; this row read *"still owed"*. **Both were written after the P1.1 override, neither cited the other**, and a reader's verdict depended on which file they opened — the campaign's **index-vs-artifact** class again, this time with the two surfaces in direct contradiction rather than merely stale. Prior state preserved (SO-6): FIRED EARLY by operator override at P1.1 (2026-08-17) — the /community link shipped with PR-1/2/3 unmet; deviation recorded in ADR-054 §Status, honest-state framing shipped and guarded by R-95/R-96. |
| DP8 | P4.1 | ADR-053 visual voice (slot-contained program vs accent-only fallback) | ✅ **RULED — operator Stanley, 2026-08-23**, and **co-ruled two ADRs at one gate**: [[adr_053_visual_voice_systematization]] → **(a)**, the governed slot-contained illustration program (containment rule + per-artifact credit + generation-pipeline note); [[adr_059_token_substrate]] → **(c)**, validators without emission. Both carry a 4-field ratification block naming ⛩ DP8 (`adr_053:205-212`, `adr_059:167`) and both read `status: accepted`. ~~pending~~ *(struck 2026-09-04, SO-6 — **this row read `pending` for 12 days after its own gate fired**, exactly the P2.4 row's defect one line above and the campaign's own ⭐ **three agreeing indexes are one claim copied twice** arriving in its inverse: here **one index disagreed with the object**, and the object won. **No decision was ever owed from the operator** — do not re-convene DP8. Found by deriving the DP list against `what/decisions/` rather than reading the table, which is the only way this class is ever found.)* |
