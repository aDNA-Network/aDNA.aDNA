...
| **P3.1** | **⬅ IN PROGRESS 2026-08-20** *(post-DP6; scope corrected at O0 — twins are THREE tiers, not collections-only)* You are Rosetta in ~/aDNA/aDNA.aDNA. Execute `mission_haussmann_p3_1_md_twins.md`. Twins derive from the same single-source content as HTML; fix the old .md link targets to the new twins. |
