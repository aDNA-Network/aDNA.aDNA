...
| D4 | Visual craft · composition · responsive · perf | `/vaults/graph` · `/vaults/[slug]` · `/` diagram · header | SP-3/4/5/7 → H-5/6/7/9/11 (+ M-4/5/7) | G1, G3, G8, G9 | **active (opened 2026-06-19) — C1 partial: SP-3/M-4 `[slug]` badge tokens shipped; SP-5 graph-color decision-gated** |
