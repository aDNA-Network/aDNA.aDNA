...
>
> **Remaining: S4** (housekeeping batch, Obj 9–13 — incl. the 37→40 vault-count reconciliation) **· S3** (Phase-1b verification sweep — light-mode axe on all routes, score the ~25 un-scored routes + 404, generated-detail-page axe sample, mobile-qual, RSS/search/print decisions; **run last** so it covers S2+S4). Commit-only; bundle into the E5-close deploy.
