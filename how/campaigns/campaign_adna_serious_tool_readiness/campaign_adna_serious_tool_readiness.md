...
created: 2026-05-17
updated: 2026-05-18  # M1.3 S3 close + mission COMPLETED + M1.4 marked next
...
| M1.4 | LatticeScope.aDNA v0.1.1 schema activation for observability (absorbs v2 M10; primary scope: Amendment D `transcript_path` ingestion + Amendments A/B/C/E hook + collector enhancements; bootstraps `LatticeScope.aDNA/` sub-vault if needed) | 2-3 | M1.3 | **next** (operator-gated entry per Standing Order #1; M1.3 close UNBLOCKS) |
