...
| M1.3 | Token audit + measurement protocol activation (absorbs v2 M09) | 2-3 | M1.2 | **in_progress** (S1 opened 2026-05-18T19:33Z; mission spec + hook spec + Type A baseline landed; S2 destructive entry operator-gated) |
