...
created: 2026-05-17
updated: 2026-05-19  # M1.4 S2 CLOSED (2026-05-19T17:58:50Z); schema migration LIVE (user_version 0→101) + hook v0.1.1 LIVE (Amendments D+E+A+B+C) + ingest_transcript.py --all backfill of 48 jsonl (645,265 kT cache_read); S3 (validation + AAR + token_baselines refresh) pending
