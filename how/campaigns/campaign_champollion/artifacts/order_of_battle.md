...
| 2 graduation seeds (3rd-instance gated) | `skill_documentation_layout_props_additive_extension` (2/3) · `skill_inline_svg_raw_import_currentColor_inheritance` (1/3); no backlog files — STATE-only tracking | **M3.2** (instance check + proper backlog filing) |
