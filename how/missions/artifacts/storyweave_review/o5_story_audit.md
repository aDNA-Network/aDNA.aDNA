...
- **"Network of one / no real humans"** — every vault is "tended by" an AI-persona code-name; an outsider finds no accountable person, team, or external adopter. The personas are an internal device that has become the *public face*. **→ RESOLVED 2026-07-07 (operator): progressive humanization** — show the real FA + Wilhelm partner now; frame the agent-personas honestly; grow real faces/stewards/communities/leaders as the network grows ([[governance_and_mission_resolution]] §7).
