...
- **"Democracy" vs "Founding Architect"** — the manifesto's "self-governed context democracy" contradicts the `reference` Governance card's single-BDFL model. The claim is *declared, not earned*.
