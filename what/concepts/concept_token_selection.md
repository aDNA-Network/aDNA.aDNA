...
- [[what/concepts/concept_convergence|Convergence Model]] — the structural principle that makes token selection scale across campaign → mission → objective
- [[what/concepts/concept_governance_files|Governance Files]] — the orientation layer that consumes the first ~5K tokens in every session
- [[what/concepts/concept_knowledge_graph|Knowledge Graph]] — the connected structure that AGENTS.md routing traverses during selection
