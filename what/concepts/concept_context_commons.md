...
**The base template**: The upstream `.adna/` template (github.com/aDNA-Network/aDNA) is itself a commons contribution — a shared, forkable starting point that reduces the cost of creating new aDNA projects from hours to minutes. Every `.aDNA/` project in the workspace was forked from this commons resource.
