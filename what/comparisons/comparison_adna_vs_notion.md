...
| **Extensibility** | [[what/patterns/pattern_base_extension|Base/extension]] with typed entity system | Custom databases, formulas, integrations |
...
- **Agent-first architecture**: aDNA's governance files, AGENTS.md routing, and [[what/concepts/concept_convergence|convergence model]] were designed for AI agents to navigate systematically. Notion AI is a feature; aDNA is an architecture.
...
- **Typed knowledge**: aDNA's entity types and [[what/concepts/concept_fair_metadata|FAIR metadata]] make knowledge machine-queryable and standards-compliant. Notion databases are flexible but project-specific.
...
- [[what/concepts/concept_open_standard|Open Standard]] — why aDNA is a standard rather than a platform (contrast with Notion's approach)
- [[what/concepts/concept_governance_files|Governance Files]] — aDNA's agent-orientation layer that Notion lacks
- [[what/concepts/concept_context_commons|Context Commons]] — the shared-knowledge vision enabled by federation, impossible with siloed platforms
