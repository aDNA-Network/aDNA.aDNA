...
> Adopted per [`CONTRIBUTING.md`](CONTRIBUTING.md) and [`who/governance/VISION.md`](who/governance/VISION.md),
> which name the Contributor Covenant v2.1 as this project's Code of Conduct. This file closes the reference both
> documents made to a `CODE_OF_CONDUCT.md` that had not yet been added.
