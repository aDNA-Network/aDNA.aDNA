...
21 base skills (inherited from the `.adna/` template) + 29 project-specific. Full inventory in [`CLAUDE.md`](CLAUDE.md) §Skills; representative project-specific examples:
