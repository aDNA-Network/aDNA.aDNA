---
title: "Agent-First Guide — aDNA Reference"
description: "This guide is for developers who want to use aDNA with Claude Code (or another AI coding agent) from the terminal, without installing Obsidian. If you a..."
ref_title: "Agent-First Guide"
stability: "stable"
---
...
This guide is for developers who want to use aDNA with Claude Code (or another AI coding agent) from the terminal, without installing Obsidian. If you already use Obsidian, you don't need this — the [Quick Start](/get-started/) covers everything.
...
| 16 base entity types | Naming conventions + frontmatter schemas. No Obsidian dependency. |
...
Use the starter templates in the [Migration Guide](/reference/migration-guide/) § 6 for copy-paste-ready governance files.
...
*Agent-first guide v1.0 | Companion to the [Migration Guide](/reference/migration-guide/), [aDNA Standard](/reference/specification/), and [Architecture Overview](/reference/design-rationale/)*
