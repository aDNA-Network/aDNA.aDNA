...
The [aDNA Universal Standard](adna_standard.md) is ~1,500 lines. You don't need all of them. This guide maps three reading paths by what you're trying to do, provides a section-by-section table of contents, and disambiguates the skill/lattice dual identity.
