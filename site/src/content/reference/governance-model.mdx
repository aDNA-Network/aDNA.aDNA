...
| Track | Cadence | Scope |
|-------|---------|-------|
| **Standard** (`adna_standard.md` version) | As needed | Normative specification changes — conformance levels, required files, naming rules |
...
1. **Open a GitHub Issue** using the "Change proposal" issue template
