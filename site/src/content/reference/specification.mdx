---
title: "aDNA Specification — aDNA Reference"
description: "Agentic DNA (aDNA) — A knowledge architecture standard for AI-native projects."
ref_title: "aDNA Specification"
stability: "stable"
version: "2.5"
---

{/*  v2.5 | 2026-07-02 | ADR-046 (Champollion G2): §7.2 per-class frontmatter profile + §5.5 walk scope (ADR-044) · new §7.7 decision-record ratification discipline · §5.3 federation/ optional row (ADR-045) · §15.4 version-cut checklist. Body mirrored from what/docs/adna_standard.md v2.5.  */}
