---
title: "Tool Setup — aDNA Reference"
description: "All setups require: - Git (for cloning and version control) - A text editor that can read markdown and YAML - Python 3.8+ (for validation tooling)"
ref_title: "Tool Setup"
stability: "stable"
---
