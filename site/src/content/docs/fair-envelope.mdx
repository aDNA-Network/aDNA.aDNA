...
description: "A shareable object without a label is a black box — nobody outside your project can find it, tell if it's trustworthy, know who made it, or use it legal..."
...
- [FAIR Metadata](/learn/concepts/fair-metadata) — the concept explaining why FAIR matters and how it works
- [Federation Readiness](/patterns/federation-readiness) — the broader checklist that includes FAIR as a prerequisite
- [Context Commons](/learn/concepts/context-commons) — the community sharing vision FAIR enables
