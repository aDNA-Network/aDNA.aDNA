---
title: "FAIR Envelope — aDNA Patterns"
description: "A lattice, module, or dataset that lacks standardized metadata is a black box. Other projects can't discover it, can't assess whether it's trustworthy, ..."
doc_title: "FAIR Envelope"
section: "patterns"
order: 6
---
...
<CardGrid columns={2} cards={[
  { title: "FAIR Metadata", href: "/learn/concepts/fair-metadata", description: "The concept behind the envelope — why two required fields unlock four downstream properties." },
  { title: "Federation Readiness", href: "/patterns/federation-readiness", description: "The 6-point checklist that includes the FAIR envelope as its licensing and findability prerequisite." },
  { title: "Context Commons", href: "/learn/concepts/context-commons", description: "The community-sharing vision that the envelope turns from ambition into an enforceable contract." },
  { title: "Open Standard", href: "/learn/concepts/open-standard", description: "The governance model that keeps the envelope's field names stable across every aDNA instance." }
]} />

## Related Elsewhere

<CardGrid columns={2} cards={[
  { title: "Lattice Composition", href: "/learn/concepts/lattice-composition", description: "The composition model the envelope makes safe — cross-project reuse with trust intact." },
  { title: "Ontology", href: "/learn/concepts/ontology", description: "The entity types — module, dataset, lattice — the envelope wraps with required metadata." },
  { title: "Build a Lattice", href: "/learn/tutorials/build-a-lattice", description: "Hands-on: author a lattice whose FAIR block passes the validator at commit time." },
  { title: "Federate a Vault", href: "/learn/tutorials/federate-a-vault", description: "Watch the envelope earn its keep — the metadata block that turns export into an enforceable contract." }
]} />
