...
When you're unsure where a file belongs, apply the <GlossaryTooltip term="question test" slug="question-test" definition="The three-question filing rule: 'Is this about what we know, how we work, or who is involved?' Routes any new file to the correct triad leg." /> (§3.1): "Is this about WHAT we know, HOW we work, or WHO is involved?"
...
- <GlossaryTooltip term="Bare triad" slug="bare-triad" definition="The deployment where what/, how/, who/ sit directly at project root. Used when aDNA IS the project — docs vaults, knowledge bases." /> — `what/`, `how/`, `who/` sit at project root. Used when aDNA IS the primary content (knowledge bases, documentation vaults).
- <GlossaryTooltip term="Embedded triad" slug="embedded-triad" definition="The deployment where the triad lives inside .agentic/ at repo root. Used to add agent support to an existing codebase without reshaping it." /> — the triad lives inside `.agentic/` at repo root. Used when adding agent support to an existing codebase.
...
<CardGrid columns={2} cards={[
  { title: "The Question Test", href: "/patterns/question-test", description: "The three-question filing rule that turns the triad into a daily decision any contributor can make." },
  { title: "Base/Extension", href: "/patterns/base-extension", description: "How to add domain types under the right leg without breaking the three-category invariant." },
  { title: "Navigate an aDNA Vault", href: "/learn/tutorials/navigate-a-vault", description: "A 15-minute walkthrough where the triad stops being a diagram and starts being a navigation instinct." },
  { title: "Apply the Question Test", href: "/learn/tutorials/question-test", description: "Practice sorting ten items into what/how/who — the triad drill every new contributor runs once." }
]} />
