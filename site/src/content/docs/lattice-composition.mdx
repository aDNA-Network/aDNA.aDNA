...
<MermaidDiagram chart={`graph LR
    A["Lattice A\nData retrieval"] -->|"seam edge"| C["Composed Lattice\nFull pipeline"]
    B["Lattice B\nReasoning"] -->|"seam edge"| C
    C --> D["Artifact\nor Result"]`} caption="Lattice composition connects smaller workflows into larger pipelines" />
