...
description: "Big jobs are usually too big for one workflow. Lattice composition is how aDNA snaps smaller workflows together to make bigger ones — the same way a din..."
...
<MermaidDiagram chart={`graph LR
    A["Lattice A — Data retrieval"] -->|"seam edge"| C["Composed Lattice"]
    B["Lattice B — Reasoning"] -->|"seam edge"| C
    C --> D["Artifact or Result"]`} caption="Lattice composition connects smaller workflows into larger pipelines" />
