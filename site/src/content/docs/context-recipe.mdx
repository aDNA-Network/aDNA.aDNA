...
<CardGrid columns={2} cards={[
  { title: "Governance Files", href: "/learn/concepts/governance-files", description: "CLAUDE.md's context-loading block is itself a recipe — governance files as the first recipe every project ships with." },
  { title: "Knowledge Graph", href: "/learn/concepts/knowledge-graph", description: "Recipes curate subgraph selections — graph traversal shortcuts with names." },
  { title: "Write a Context File", href: "/learn/tutorials/write-a-context-file", description: "Author a context file a recipe will reference — the per-file work recipes compose." },
  { title: "Design a Mission", href: "/learn/tutorials/design-a-mission", description: "Pre-define the context assembly for common mission types — recipes at the planning layer." }
]} />
