---
title: "Vault Exploration — aDNA Workshops"
description: "A 60-minute guided tour of a living aDNA vault. Participants don't build anything — they navigate, observe, and discover how a knowledge architecture wo..."
doc_title: "Vault Exploration"
section: "workshops"
order: 1
---
...
- [Navigate an aDNA Vault](/learn/tutorials/navigate-a-vault) (15 min) — guided tour of vault structure
- [Apply the Question Test](/learn/tutorials/question-test) (15 min) — sorting rule for the triad
...
**Instructions**: For each item below, decide which triad leg it belongs to by asking the [Question Test](/patterns/question-test):
...
- [Build Your First Vault](/how/workshops/build-your-first-vault) — next workshop in the series
- [Facilitation Guide](/how/workshops/facilitation-guide) — meta-guide for running any aDNA workshop
- [The Triad](/learn/concepts/triad) — the concept this workshop teaches
- [The Question Test](/patterns/question-test) — the sorting pattern participants practice
