...
|-------|-----------|----------------|---------|
| **Upstream spec** | aDNA Standard v2.2 — normative rules using RFC 2119 keywords (MUST, SHOULD, MAY) | Open governance (github.com/LatticeProtocol/aDNA) | "Every instance MUST use the what/how/who triad" |
