...
<MermaidDiagram chart={`graph LR
    L0["L0 Aware\nknows AI exists"] --> L1["L1 User\nprompts agents"]
    L1 --> L2["L2 Builder\nstructures context with aDNA"]
    L2 --> L3["L3 Architect\ndesigns lattices and campaigns"]`} caption="Four levels of agentic literacy — from awareness to architecture" />
...
- [Dual-Audience Writing](/learn/concepts/dual-audience) — the writing discipline that makes knowledge serve both humans and agents
- [Context Commons](/learn/concepts/context-commons) — the vision of shared knowledge resources that agentic literacy makes possible
- [Open Standard](/learn/concepts/open-standard) — how openness lowers the barrier to developing agentic literacy
- [The Triad](/learn/concepts/triad) — the organizing principle that is the first lesson in agentic literacy
