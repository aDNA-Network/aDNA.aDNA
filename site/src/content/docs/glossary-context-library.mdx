---
title: "Context Library — aDNA Glossary"
description: "The context library is a structured knowledge store inside `what/context/` that agents load before starting domain work."
doc_title: "Context Library"
section: "glossary"
order: 23
---
...
- [Context Optimization (concept)](/learn/concepts/context-optimization)
- [Token Selection (concept)](/learn/concepts/token-selection)
- [what/](/glossary/glossary-what)
