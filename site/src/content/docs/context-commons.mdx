...
<MermaidDiagram chart={`graph TD
    pub["Public — open specs and standards"]
    shared["Shared — community lattices"]
    org["Org — team and domain context"]
    priv["Private — project and session"]
...
**The base template**: The upstream `adna/` repository (github.com/LatticeProtocol/aDNA) is itself a commons contribution — a shared, forkable starting point that reduces the cost of creating new aDNA projects from hours to minutes. Every `.aDNA/` project in the workspace was forked from this commons resource.
