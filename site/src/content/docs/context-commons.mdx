...
description: "The Context Commons is the vision of a community-maintained library of context files, lattices, and patterns that anyone can use, improve, and share. Bu..."
...
**The <GlossaryTooltip term="context library" slug="context-library" definition="The structured knowledge store in what/context/ — organized by topic with subtopics and token estimates so agents load only what they need." /> itself**: `what/context/` contains 5 topics, 27 subtopics, and ~75K tokens of curated knowledge. This library was created for this vault but is designed to be sharable: every file has FAIR-aligned metadata (sources, tags, quality scores), token estimates, and self-contained content. It's a proto-commons.
...
**FAIR metadata everywhere**: Every object in this vault carries the metadata envelope that makes commons participation possible — `keywords`, `license`, `provenance`, `sources` — declared in each file's <GlossaryTooltip term="frontmatter" slug="frontmatter" definition="The YAML metadata block at the top of every aDNA file, wrapped in --- fences. Records type, dates, editor, tags — the file's ID card." />. The infrastructure is in place; the community scales it.
...
<CardGrid columns={2} cards={[
  { title: "FAIR Metadata", href: "/learn/concepts/fair-metadata", description: "The metadata standard that makes commons resources findable, trustworthy, and reusable." },
  { title: "Agentic Literacy", href: "/learn/concepts/agentic-literacy", description: "The literacy movement the commons accelerates by providing real examples." },
  { title: "Open Standard", href: "/learn/concepts/open-standard", description: "The open governance model that enables a commons to exist without vendor lock-in." },
  { title: "Lattice Composition", href: "/learn/concepts/lattice-composition", description: "The composability that makes commons lattices useful in new projects." }
]} />

## Related Elsewhere

<CardGrid columns={2} cards={[
  { title: "FAIR Envelope", href: "/patterns/fair-envelope", description: "The metadata block every commons resource needs before strangers can trust it — license and keywords minimum." },
  { title: "Federation Readiness", href: "/patterns/federation-readiness", description: "The six checks that turn a local lattice into a commons-shareable artifact." },
  { title: "Federate a Vault", href: "/learn/tutorials/federate-a-vault", description: "Walk through exporting, importing, and composing across aDNA instances — commons mechanics, end to end." },
  { title: "Build a Lattice", href: "/learn/tutorials/build-a-lattice", description: "Build a FAIR-annotated lattice from scratch — the atomic contribution unit a commons depends on." }
]} />
