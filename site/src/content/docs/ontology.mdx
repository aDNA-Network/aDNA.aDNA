...
description: "The aDNA ontology is a typed vocabulary of 16 base entity types — organized across the triad — that defines what kinds of things a project can contain. ..."
...
<MermaidDiagram chart={`graph LR
    ...
    HOW --> campaigns & missions & sessions & templates & skills & pipelines & backlog`} caption="16 base entity types organized across the aDNA Triad" />
