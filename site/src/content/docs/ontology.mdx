...
The real power is extensibility. The 14 base types handle operations, but your project probably has domain-specific things too — patients, experiments, customers, models. You add those as <GlossaryTooltip term="ontology extensions" slug="ontology-extension" definition="A new entity type a project adds beyond aDNA's base 14 — a subdirectory under the right triad leg with its own AGENTS.md and template." /> under the appropriate triad leg, and they inherit the same conventions: typed frontmatter, AGENTS.md guides, templates. The base vocabulary is shared; the extensions are yours.
...
Every content file in an aDNA vault MUST include a `type` field in its YAML <GlossaryTooltip term="frontmatter" slug="frontmatter" definition="The YAML metadata block at the top of every aDNA file, wrapped in --- fences. Records type, dates, editor, tags — the file's ID card." /> (§7.2). This field is the machine-readable identity of the entity:
...
<CardGrid columns={2} cards={[
  { title: "The Triad", href: "/learn/concepts/triad", description: "The three-leg structure that the ontology populates." },
  { title: "Knowledge Graph", href: "/learn/concepts/knowledge-graph", description: "How typed entities connect into a navigable web." },
  { title: "Convergence Model", href: "/learn/concepts/convergence", description: "How the ontology enables context narrowing." }
]} />

## Related Elsewhere

<CardGrid columns={2} cards={[
  { title: "Base/Extension", href: "/patterns/base-extension", description: "The rule that keeps the base 14 frozen while projects extend freely — ontology evolution without schism." },
  { title: "The Question Test", href: "/patterns/question-test", description: "The filing rule every ontology decision rests on: which leg, which type, which directory." },
  { title: "Extend the Ontology", href: "/learn/tutorials/extend-the-ontology", description: "Hands-on: add a custom entity type under the right triad leg — three artifacts, one pattern." },
  { title: "Apply the Question Test", href: "/learn/tutorials/question-test", description: "Practice sorting ten real items into what/how/who — ontology as daily discipline." }
]} />
