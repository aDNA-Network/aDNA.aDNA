...
<CardGrid columns={2} cards={[
  { title: "Quality Rubric", href: "/reference/quality-rubric", description: "The 6-axis rubric — signal density, actionability, coverage, and more — used to score every aDNA context file." },
  { title: "Agent-First Guide", href: "/reference/agent-first-guide", description: "The practical companion to the spec — how agents should use optimization principles when loading context for a task." }
]} />
