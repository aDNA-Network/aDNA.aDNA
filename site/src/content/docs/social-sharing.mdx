...
description: "How the site's OG (Open Graph) social-preview system works: branded preview images, section-aware selection, and how to configure previews for the vault."
