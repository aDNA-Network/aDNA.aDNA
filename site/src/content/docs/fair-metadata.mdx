...
**Context file frontmatter**: Look at the <GlossaryTooltip term="frontmatter" slug="frontmatter" definition="The YAML metadata block at the top of every aDNA file, wrapped in --- fences. Records type, dates, editor, tags — the file's ID card." /> of any context file — e.g., `what/context/adna_core/context_adna_core_paradigm_overview.md`. The `sources` field is provenance. The `tags` field serves the findability role that `keywords` serves in YAML objects.
...
<CardGrid columns={2} cards={[
  { title: "Lattice Composition", href: "/learn/concepts/lattice-composition", description: "The workflow composition that FAIR metadata makes shareable and trustworthy." },
  { title: "Ontology", href: "/learn/concepts/ontology", description: "The entity types — module, dataset, lattice — that carry FAIR envelopes." },
  { title: "Context Commons", href: "/learn/concepts/context-commons", description: "The vision of community-shared knowledge that FAIR principles enable." },
  { title: "Open Standard", href: "/learn/concepts/open-standard", description: "How FAIR metadata fits into aDNA's broader open governance model." }
]} />

## Related Elsewhere

<CardGrid columns={2} cards={[
  { title: "FAIR Envelope", href: "/patterns/fair-envelope", description: "The concrete YAML block — two required fields — that materializes the FAIR principles into real files." },
  { title: "Federation Readiness", href: "/patterns/federation-readiness", description: "The checklist that leans on FAIR metadata as its licensing and findability gate." },
  { title: "Build a Lattice", href: "/learn/tutorials/build-a-lattice", description: "Hands-on: author a FAIR-annotated lattice from scratch — `keywords` and `license` enforced at validate time." },
  { title: "Federate a Vault", href: "/learn/tutorials/federate-a-vault", description: "Export, import, and compose lattices across instances — FAIR metadata is the trust boundary between them." }
]} />

## From the Reference

<CardGrid columns={2} cards={[
  { title: "Quality Rubric", href: "/reference/quality-rubric", description: "The 6-axis rubric used to score aDNA knowledge objects — including how FAIR completeness maps to coverage and reproducibility scores." },
  { title: "Specification", href: "/reference/specification", description: "Normative aDNA specification — §7 defines the type vocabulary; §11 defines federation readiness checks including FAIR requirements." }
]} />
