...
description: "FAIR is a simple four-question test: can someone else Find your work, Access it, Interoperate with it, and Reuse it? aDNA bakes that test into every pie..."
...
<MermaidDiagram chart={`graph LR
    ...
    A --> I["Interoperable\nshared vocabulary"]
    I --> R["Reusable\nprovenance + license"]`} caption="FAIR: four requirements for knowledge objects that can be shared" />
