...
| **Knowledge types** | 16+ entity types with typed frontmatter | Untyped: any note can go anywhere within the 4 buckets |
...
- aDNA Standard v2.2, §1 (Introduction), §3 (Triad Architecture) — aDNA specification
