...
description: "A project folder can hold hundreds of files. An AI agent working on a single task needs only a handful of them — but how does it know which folders to o..."
...
- [Convergence Model](/learn/concepts/convergence) — the structural principle that AGENTS.md routing implements
- [Token Selection](/learn/concepts/token-selection) — the broader discipline of choosing what to load
- [Context Recipe](/patterns/context-recipe) — multi-directory assembly that builds on AGENTS.md routing
