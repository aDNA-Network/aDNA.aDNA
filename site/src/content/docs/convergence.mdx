...
<CardGrid columns={2} cards={[
  { title: "Specification", href: "/reference/specification", description: "Normative aDNA specification — §5 defines the execution hierarchy (Campaign → Mission → Objective) and context convergence model." },
  { title: "Agent-First Guide", href: "/reference/agent-first-guide", description: "Practical guidance for agents implementing convergent context loading — what to load, what to skip, and why." }
]} />
