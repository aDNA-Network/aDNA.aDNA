...
<MermaidDiagram chart={`graph LR
    Campaign["Campaign (100+ files)"] --> Mission["Mission (5–10 files)"]
    Mission --> Objective["Objective (2–3 files)"]
    Objective --> Session["Session (1 context window)"]`} caption="Convergence narrows knowledge at each execution level" />
