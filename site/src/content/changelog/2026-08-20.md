---
title: "2026-08-20 — A proposal process, and the site in markdown"
description: "A numbered public process for proposing changes to the standard. And every page is now readable as markdown, by any agent that asks for it."
version: "2026-08-20"
date: 2026-08-20
breaking: false
highlights:
  - "New: every page has a markdown twin at the same address with a .md suffix — and the same markdown is served on the ordinary URL to anything sending Accept: text/markdown"
  - "New: llms-full.txt is now the whole site as markdown, about 900 KB, instead of a 2 KB index that had been wearing the name"
  - "Fixed: llms.txt existed and worked but was named nowhere on the site, so an agent had to already know the convention to find it"
