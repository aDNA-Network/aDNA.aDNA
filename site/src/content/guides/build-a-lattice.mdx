...
<CardGrid columns={2} cards={[
  { title: "Lattice Composition", href: "/learn/concepts/lattice-composition", description: "The composition patterns that determine how your new lattice will plug into bigger workflows." },
  { title: "FAIR Metadata", href: "/learn/concepts/fair-metadata", description: "The four principles the YAML block you're about to write encodes." },
  { title: "FAIR Envelope", href: "/patterns/fair-envelope", description: "The concrete YAML shape the validator will check — nested under `fair:` in every lattice file." },
  { title: "Context Recipe", href: "/patterns/context-recipe", description: "How this lattice will later be assembled into recurring tasks — recipes at the composition layer." }
]} />
