...
├── concepts/      ← Core aDNA concepts (dual-audience — you can read them!)
├── tutorials/     ← You are here
├── patterns/      ← Reusable architectural patterns
├── comparisons/   ← aDNA vs. other systems (honest positioning)
├── glossary/      ← Canonical term definitions
├── use_cases/     ← Adoption stories by domain
...
├── workshops/     ← Workshop kits + facilitation guides
├── publishing/    ← Vault-to-web publishing pipeline
...
└── adopters/      ← Adopter personas + deployment profiles
```
...
- [Create Your First CLAUDE.md](/learn/tutorials/first-claude-md) — build the agent-orientation file
- [The Triad](/learn/concepts/triad) — deeper understanding of the organizing principle
