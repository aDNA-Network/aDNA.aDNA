---
title: "Apply the Question Test — aDNA Tutorial"
description: "A sorted inventory of 10 project items placed into the correct triad leg. By the end, you'll be able to instantly sort any new file into what/, how/, or..."
guide_title: "Apply the Question Test"
difficulty: "beginner"
...
A sorted inventory of 10 project items placed into the correct <GlossaryTooltip term="triad" slug="triad" definition="The three-folder structure at every aDNA project's root: what/, how/, who/. Every file fits in exactly one — the universal classifier." /> leg. By the end, you'll be able to instantly sort any new file into `what/`, `how/`, or `who/` using the [question test](/patterns/question-test).

## Prerequisites

- Understand the [triad](/learn/concepts/triad) (what/how/who)
- Understand the [ontology](/learn/concepts/ontology) (entity types within each leg)
...
- The [question test](/patterns/question-test) always produces exactly one answer
...
<CardGrid columns={2} cards={[
  { title: "Extend the Ontology", href: "/learn/tutorials/extend-the-ontology", description: "Add custom entity types under the right triad leg." },
  { title: "Ontology", href: "/learn/concepts/ontology", description: "Understand the entity types within each triad leg." },
  { title: "Base/Extension", href: "/patterns/base-extension", description: "How to add types without breaking the core 14." }
]} />

## Related Elsewhere

<CardGrid columns={2} cards={[
  { title: "The Triad", href: "/learn/concepts/triad", description: "The three-category principle behind the three-question sort." },
  { title: "Knowledge Graph", href: "/learn/concepts/knowledge-graph", description: "Why correctly filed files stay findable — placement is graph hygiene." },
  { title: "The Question Test", href: "/patterns/question-test", description: "The pattern doc behind this drill — decision rules, edge cases, anti-patterns." },
  { title: "AGENTS.md Routing", href: "/patterns/agents-md", description: "How the routing layer benefits when every file is on the right leg." }
]} />
