...
- [Extend the Ontology](/learn/tutorials/extend-the-ontology) — add custom entity types to the triad
- [Ontology](/learn/concepts/ontology) — understand the entity types within each leg
- [Base/Extension](/patterns/base-extension) — how to add types without breaking the core
