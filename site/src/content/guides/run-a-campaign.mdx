...
A campaign document with phased execution, a <GlossaryTooltip term="mission" slug="mission" definition="A chunk of work too big for one session. Breaks a goal into objectives, each small enough for a single agent session. Bridges campaigns to sessions." /> board, and quality gates. By the end, you'll have a strategic plan that can coordinate multiple agents across multiple sessions toward a shared goal.
...
Create the first mission file inside `how/campaigns/campaign_{name}/missions/`. Claim the first objective. Start a <GlossaryTooltip term="session" slug="session" definition="One stretch of work by an agent. Clear start, middle, and end — each session produces a file that records what happened and leaves an audit trail." />. Do the work. Close with a SITREP.
...
<CardGrid columns={2} cards={[
  { title: "Federate a Vault", href: "/learn/tutorials/federate-a-vault", description: "Share your campaign's outputs with other aDNA projects." },
  { title: "Open Standard", href: "/learn/concepts/open-standard", description: "How campaigns contribute to the broader aDNA ecosystem." }
]} />

## Related Elsewhere

<CardGrid columns={2} cards={[
  { title: "Convergence Model", href: "/learn/concepts/convergence", description: "The structural principle your campaign will implement across its phases and missions." },
  { title: "Governance Files", href: "/learn/concepts/governance-files", description: "STATE.md, CLAUDE.md, campaign master doc — the files your campaign writes into." },
  { title: "Mission Decomposition", href: "/patterns/mission-decomposition", description: "The decomposition recipe every campaign phase will apply." },
  { title: "Context Recipe", href: "/patterns/context-recipe", description: "Pre-validated context assemblies for recurring mission types — reused across the whole campaign." }
]} />
