...
- [Apply the Question Test](/learn/tutorials/question-test) — practice sorting content into the triad
- [Token Selection](/learn/concepts/token-selection) — how CLAUDE.md fits into the token budget
