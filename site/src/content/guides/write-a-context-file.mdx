...
- [Design a Mission](/learn/tutorials/design-a-mission) — plan multi-session work using the execution hierarchy
- [Context Recipe](/patterns/context-recipe) — combine context files into task-specific assemblies
